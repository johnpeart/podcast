		...
		<tr>
			<td rowspan="4" valign="top" style="min-width: 140px; max-width: 140px; padding-right: 10px; vertical-align: top;">
				<div style="border-left: 2px solid #d40072; padding-left: 6px;">
					<img border="0" alt="Logo" width="40" style="display: block; width:40px; height:auto; border:0; clear: both; margin-bottom: 6px;" src="https://podcast.johnpe.art/assets/images/email/work-logo.png">
